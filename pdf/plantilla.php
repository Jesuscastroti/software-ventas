<?php 
	...
	ini_set('date.timezone', 'America/Bogota');	// Iniciando la zona horaria
	/**
	...
	*/
	class Productos extends FPDF{
		...
		function Header(){
			...
			$this->SetFont('Arial','B',15);
			$this->Cell(30);
			$this->Cell(120,10,utf8_decode( 'Listado de Productos'),0,0,'C');
			$this->SetFont('Arial','B',10);
			$this->Cell(50, 10, 'Hoy: '.date('d/m/Y').'', 0);
			$this->Ln(20);
	...
	*/
	...
	class VentaDiario extends FPDF{
		...
		function Header(){
			...
			$this->SetFont('Arial','B',15);
			$this->Cell(30);
			$this->Cell(120,10,utf8_decode( 'Ventas del Dia'),0,0,'C');
			$this->SetFont('Arial','B',10);
			$this->Cell(50, 10, 'Hoy: '.date('d/m/Y').'', 0);
			$this->Ln(20);
