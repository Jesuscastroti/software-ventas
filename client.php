	      		...
	      		<div class="div-result">
				 			...
				 			<form class="form-horizontal" id="editClientForm" action="php_action/editClient.php" method="POST">
								...
								<div class="form-group">
						        	<label for="editClientID" class="col-sm-3 control-label">Identificacion: </label>
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitClientForm" action="php_action/createClient.php" method="POST" enctype="multipart/form-data">
			    ...
			    <div class="modal-body" style="max-height:450px; overflow:auto;">
					...
					<div class="form-group">
			        	<label for="clientId" class="col-sm-3 control-label">Identificacion: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="number" class="form-control" id="clientId" placeholder="Numero identificacion" name="clientId" autocomplete="off">
						    </div>
	        		</div>
	        		...
	        		<div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type=email class="form-control" id="clientEmail" placeholder="Email del Cliente" name="clientEmail" autocomplete="off">
						    </div>
	        		</div> <!-- /form-group--> 
	        		...
	        		<div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="number" class="form-control" id="clientTelefono" placeholder="Telefono del Cliente" name="clientTelefono" autocomplete="off">
						    </div>
	        		</div> <!-- /form-group-->  
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Cerrar</button>
					<button type="submit" class="btn btn-primary" id="createClientBtn" data-loading-text="Guardando..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> Guardar cambios</button>
				</div><!-- /modal-footer -->	 
